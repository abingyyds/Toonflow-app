...
const vendor: VendorConfig = {
  ...
  inputs: [
    ...
    { key: "baseUrl", label: "请求地址", type: "url", required: true, placeholder: "默认：https://api.toonflow.net/v1" },
  ],
  inputValues: { accessKey: "", secretKey: "", baseUrl: "https://api.toonflow.net/v1" },
  models: [
    // kling-video-o1 (Omni)
    {
...
const getBaseUrl = (): string => {
  return vendor.inputValues.baseUrl || "https://api.toonflow.net/v1";
};
